...
export const teams: Team[] = [
  ...
  { id: "ecuador", name: "Ecuador", countryCode: "ECU", confederation: "CONMEBOL", group: "A", flag: "🇪🇨", fifaRanking: 31, elo: 1810, gdpPerCapita: 6400, population: 18000000, managerNationality: "Spain", sameNationalityManager: false, squadQuality: 70, recentForm: 64, climateFamiliarity: 78 },
  { id: "ghana", name: "Ghana", countryCode: "GHA", confederation: "CAF", group: "A", flag: "🇬🇭", fifaRanking: 68, elo: 1690, gdpPerCapita: 2400, population: 33500000, managerNationality: "Ghana", sameNationalityManager: true, squadQuality: 64, recentForm: 52, climateFamiliarity: 88 },
  ...
  { id: "tunisia", name: "Tunisia", countryCode: "TUN", confederation: "CAF", group: "B", flag: "🇹🇳", fifaRanking: 49, elo: 1720, gdpPerCapita: 3800, population: 12300000, managerNationality: "Tunisia", sameNationalityManager: true, squadQuality: 62, recentForm: 55, climateFamiliarity: 84 },
  ...
  { id: "sweden", name: "Sweden", countryCode: "SWE", confederation: "UEFA", group: "C", flag: "🇸🇪", fifaRanking: 27, elo: 1820, gdpPerCapita: 56000, population: 10500000, managerNationality: "Sweden", sameNationalityManager: true, squadQuality: 72, recentForm: 60, climateFamiliarity: 55 },
  ...
  // ---------------- Group F ----------------
  { id: "brazil", name: "Brazil", countryCode: "BRA", confederation: "CONMEBOL", group: "F", flag: "🇧🇷", fifaRanking: 5, elo: 2030, gdpPerCapita: 8900, population: 216400000, managerNationality: "Brazil", sameNationalityManager: true, squadQuality: 89, recentForm: 78, climateFamiliarity: 88 },
  ...
  { id: "switzerland", name: "Switzerland", countryCode: "SUI", confederation: "UEFA", group: "G", flag: "🇨🇭", fifaRanking: 19, elo: 1855, gdpPerCapita: 92400, population: 8800000, managerNationality: "Italy", sameNationalityManager: false, squadQuality: 74, recentForm: 63, climateFamiliarity: 58 },
  ...
  { id: "panama", name: "Panama", countryCode: "PAN", confederation: "CONCACAF", group: "G", flag: "🇵🇦", fifaRanking: 41, elo: 1740, gdpPerCapita: 17000, population: 4400000, managerNationality: "Panama", sameNationalityManager: true, squadQuality: 60, recentForm: 56, climateFamiliarity: 87 },

  // ---------------- Group H ----------------
  { id: "england", name: "England", countryCode: "ENG", confederation: "UEFA", group: "H", flag: "🏴󠁧󠁢󠁥󠁮󠁧󠁿", fifaRanking: 4, elo: 2055, gdpPerCapita: 46100, population: 56500000, managerNationality: "England", sameNationalityManager: true, squadQuality: 88, recentForm: 80, climateFamiliarity: 60 },
  ...
  { id: "saudi-arabia", name: "Saudi Arabia", countryCode: "KSA", confederation: "AFC", group: "K", flag: "🇸🇦", fifaRanking: 57, elo: 1700, gdpPerCapita: 30400, population: 36900000, managerNationality: "France", sameNationalityManager: false, squadQuality: 62, recentForm: 56, climateFamiliarity: 84 },
  ...
  // ---------------- Group L ----------------
  { id: "belgium", name: "Belgium", countryCode: "BEL", confederation: "UEFA", group: "L", flag: "🇧🇪", fifaRanking: 14, elo: 1950, gdpPerCapita: 51200, population: 11700000, managerNationality: "Germany", sameNationalityManager: false, squadQuality: 84, recentForm: 72, climateFamiliarity: 60 },
  ...
  { id: "algeria", name: "Algeria", countryCode: "ALG", confederation: "CAF", group: "L", flag: "🇩🇿", fifaRanking: 35, elo: 1790, gdpPerCapita: 4300, population: 45600000, managerNationality: "Algeria", sameNationalityManager: true, squadQuality: 70, recentForm: 63, climateFamiliarity: 85 },
  { id: "new-zealand", name: "New Zealand", countryCode: "NZL", confederation: "OFC", group: "L", flag: "🇳🇿", fifaRanking: 89, elo: 1620, gdpPerCapita: 48800, population: 5200000, managerNationality: "New Zealand", sameNationalityManager: true, squadQuality: 55, recentForm: 52, climateFamiliarity: 70 },
];
