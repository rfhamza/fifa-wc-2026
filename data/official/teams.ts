...
const RAW_TEAMS: Team[] = [
  ...
  { id: "south-africa", name: "South Africa", countryCode: "RSA", confederation: "CAF", group: "A", flag: "🇿🇦", fifaRanking: 60, elo: 1700, gdpPerCapita: 6800, population: 60400000, managerNationality: "Belgium", sameNationalityManager: false, squadQuality: 63, recentForm: 60, climateFamiliarity: 84 },
  ...
  { id: "switzerland", name: "Switzerland", countryCode: "SUI", confederation: "UEFA", group: "B", flag: "🇨🇭", fifaRanking: 19, elo: 1855, gdpPerCapita: 92400, population: 8800000, managerNationality: "Switzerland", sameNationalityManager: true, squadQuality: 74, recentForm: 63, climateFamiliarity: 58 },
  ...
  // ---------------- Group C ----------------
  { id: "brazil", name: "Brazil", countryCode: "BRA", confederation: "CONMEBOL", group: "C", flag: "🇧🇷", fifaRanking: 5, elo: 2030, gdpPerCapita: 8900, population: 216400000, managerNationality: "Italy", sameNationalityManager: false, squadQuality: 89, recentForm: 78, climateFamiliarity: 88 },
  ...
  // ---------------- Group D ----------------
  { id: "usa", name: "United States", countryCode: "USA", confederation: "CONCACAF", group: "D", drawPosition: 1, drawSlot: "D1", drawSlotStatus: "verified", flag: "🇺🇸", fifaRanking: 16, elo: 1860, gdpPerCapita: 76300, population: 333300000, managerNationality: "Argentina", sameNationalityManager: false, squadQuality: 75, recentForm: 67, climateFamiliarity: 92 },
  ...
  { id: "ecuador", name: "Ecuador", countryCode: "ECU", confederation: "CONMEBOL", group: "E", flag: "🇪🇨", fifaRanking: 31, elo: 1810, gdpPerCapita: 6400, population: 18000000, managerNationality: "Argentina", sameNationalityManager: false, squadQuality: 70, recentForm: 64, climateFamiliarity: 78 },
  ...
  { id: "tunisia", name: "Tunisia", countryCode: "TUN", confederation: "CAF", group: "F", flag: "🇹🇳", fifaRanking: 49, elo: 1720, gdpPerCapita: 3800, population: 12300000, managerNationality: "France", sameNationalityManager: false, squadQuality: 62, recentForm: 55, climateFamiliarity: 84 },
  { id: "sweden", name: "Sweden", countryCode: "SWE", confederation: "UEFA", group: "F", flag: "🇸🇪", fifaRanking: 27, elo: 1820, gdpPerCapita: 56000, population: 10500000, managerNationality: "England", sameNationalityManager: false, squadQuality: 72, recentForm: 60, climateFamiliarity: 55 },

  // ---------------- Group G ----------------
  { id: "belgium", name: "Belgium", countryCode: "BEL", confederation: "UEFA", group: "G", flag: "🇧🇪", fifaRanking: 14, elo: 1950, gdpPerCapita: 51200, population: 11700000, managerNationality: "France", sameNationalityManager: false, squadQuality: 84, recentForm: 72, climateFamiliarity: 60 },
  ...
  { id: "new-zealand", name: "New Zealand", countryCode: "NZL", confederation: "OFC", group: "G", flag: "🇳🇿", fifaRanking: 89, elo: 1620, gdpPerCapita: 48800, population: 5200000, managerNationality: "England", sameNationalityManager: false, squadQuality: 55, recentForm: 52, climateFamiliarity: 70 },
  ...
  { id: "saudi-arabia", name: "Saudi Arabia", countryCode: "KSA", confederation: "AFC", group: "H", flag: "🇸🇦", fifaRanking: 57, elo: 1700, gdpPerCapita: 30400, population: 36900000, managerNationality: "Greece", sameNationalityManager: false, squadQuality: 62, recentForm: 56, climateFamiliarity: 84 },
  ...
  { id: "algeria", name: "Algeria", countryCode: "ALG", confederation: "CAF", group: "J", flag: "🇩🇿", fifaRanking: 35, elo: 1790, gdpPerCapita: 4300, population: 45600000, managerNationality: "Switzerland", sameNationalityManager: false, squadQuality: 70, recentForm: 63, climateFamiliarity: 85 },
  { id: "jordan", name: "Jordan", countryCode: "JOR", confederation: "AFC", group: "J", flag: "🇯🇴", fifaRanking: 64, elo: 1700, gdpPerCapita: 4400, population: 11300000, managerNationality: "Tunisia", sameNationalityManager: false, squadQuality: 61, recentForm: 65, climateFamiliarity: 84 },

  // ---------------- Group K ----------------
  { id: "portugal", name: "Portugal", countryCode: "POR", confederation: "UEFA", group: "K", flag: "🇵🇹", fifaRanking: 6, elo: 2025, gdpPerCapita: 24500, population: 10300000, managerNationality: "Spain", sameNationalityManager: false, squadQuality: 87, recentForm: 81, climateFamiliarity: 67 },
  ...
  // ---------------- Group L ----------------
  { id: "england", name: "England", countryCode: "ENG", confederation: "UEFA", group: "L", flag: "ENG", fifaRanking: 4, elo: 2055, gdpPerCapita: 46100, population: 56500000, managerNationality: "Germany", sameNationalityManager: false, squadQuality: 88, recentForm: 80, climateFamiliarity: 60 },
  ...
  { id: "panama", name: "Panama", countryCode: "PAN", confederation: "CONCACAF", group: "L", flag: "🇵🇦", fifaRanking: 41, elo: 1740, gdpPerCapita: 17000, population: 4400000, managerNationality: "Denmark", sameNationalityManager: false, squadQuality: 60, recentForm: 56, climateFamiliarity: 87 },
  { id: "ghana", name: "Ghana", countryCode: "GHA", confederation: "CAF", group: "L", flag: "🇬🇭", fifaRanking: 68, elo: 1690, gdpPerCapita: 2400, population: 33500000, managerNationality: "Portugal", sameNationalityManager: false, squadQuality: 64, recentForm: 52, climateFamiliarity: 88 },
];
