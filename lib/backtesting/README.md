...
- `tournament-reconstruction.ts` — **Phase 1.21B** deterministic, descriptive
  ...
  top-two against the actual Round-of-16 participants, and verifies the champion **where the pack encodes
  it** (the 2010/2014 ET finals are flagged `undetermined`, not fabricated). It computes **no**
